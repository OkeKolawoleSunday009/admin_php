                                ...
                                <table class="table-responsive w-full rounded">
                                    <thead>
                                      <tr>
                                        ...
                                        <th class="border w-1/6 px-4 py-2">State</th>
                                        <th class="border w-1/6 px-4 py-2">Local Govt</th>
                                        <th class="border w-1/7 px-4 py-2">DOB</th>
                                        <th class="border w-1/7 px-4 py-2">Course</th>
                                        <th class="border w-1/7 px-4 py-2">Fee</th>
