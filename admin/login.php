...
<body class="h-screen font-sans login bg-cover " id="login.php">
<div class="container mx-auto h-full flex flex-1 justify-center items-center">
  <div class="w-full max-w-lg">
    <div class="leading-loose">
      <form class="max-w-xl m-4 p-10 bg-white rounded shadow-xl">
        <p class="text-gray-800 font-medium text-center text-lg font-bold">Login Niit@Fortesoft</p>
        <div class="">
          <label class="block text-xm text-black font-bold" for="username">Username</label>
        ...
        <div class="mt-2">
          <label class="block text-xm text-black font-bold" for="password">Password</label>
